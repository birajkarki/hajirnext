    ...
    >
      ...
      {drawerOpen && (
        <div
          style={{
            width: '35%',
            height: '100%', // Change this to '100%' to make the drawer full height
            minWidth: '200px',
            backgroundColor: 'white',
            boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)',
            zIndex: 999, // Set a higher z-index value to ensure it appears above other elements
            position: 'fixed', // Add position fixed to keep the drawer in place
            top: 0, // Position it at the top
            right: 0, // Position it at the right
            overflowY: 'auto', // Add overflowY auto to enable scrolling if content exceeds height
          }}
        >
